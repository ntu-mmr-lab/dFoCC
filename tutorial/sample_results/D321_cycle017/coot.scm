...
(read-pdb "D321_cycle017/rc_0_0_0.pdb")

;; read the dFo region-extracted sigma-cutoff map
;; and show almost all signal on the map
;; (handle-read-ccp4-map "D321_cycle017/dFo.rc_0_0_0.masked_sigma3.0.ccp4" 1)
...
; (export-map-fragment 2 (rotation-centre-position 0) (rotation-centre-position 1) (rotation-centre-position 2) 20.0 "D321_cycle017/dFo_for_pymol.map")
...
;; (handle-read-ccp4-map "D321_cycle017/dFc.rc_0_0_0.masked_sigma3.0.ccp4" 1)
;; (set-last-map-contour-level-by-sigma 0.01)

;; read the entire dFo struct factor
;; apply suitable sigma cutoff on it
;; and change its colour into cyan-yellow pair
(make-and-draw-map "D321_cycle017/dFc.rc_0_0_0.mtz" "dFc" "dPHIc" "" 0 1)
(set-last-map-contour-level-by-sigma 33.00)
(set-last-map-colour 0.0 1.0 1.0)
; (export-map-fragment 3 (rotation-centre-position 0) (rotation-centre-position 1) (rotation-centre-position 2) 20.0 "D321_cycle017/dFc_for_pymol.map")
