...
(read-pdb "N395_cycle001/rc_120_720.pdb")

;; read the dFo region-extracted sigma-cutoff map
;; and show almost all signal on the map
;; (handle-read-ccp4-map "N395_cycle001/dFo.rc_120_720.masked_sigma3.0.ccp4" 1)
...
;; (handle-read-ccp4-map "N395_cycle001/dFc.rc_120_720.masked_sigma3.0.ccp4" 1)
;; (set-last-map-contour-level-by-sigma 0.01)

;; read the entire dFo struct factor
;; apply suitable sigma cutoff on it
;; and change its colour into cyan-yellow pair
(make-and-draw-map "N395_cycle001/dFc.rc_120_720.mtz" "dFc" "dPHIc" "" 0 1)
