...
(read-pdb "H309_cycle001/rc_1600_-400_64.pdb")

;; read the dFo region-extracted sigma-cutoff map
;; and show almost all signal on the map
;; (handle-read-ccp4-map "H309_cycle001/dFo.rc_1600_-400_64.masked_sigma3.0.ccp4" 1)
...
; (export-map-fragment 2 (rotation-centre-position 0) (rotation-centre-position 1) (rotation-centre-position 2) 20.0 "H309_cycle001/dFo_for_pymol.map")
...
;; (handle-read-ccp4-map "H309_cycle001/dFc.rc_1600_-400_64.masked_sigma3.0.ccp4" 1)
;; (set-last-map-contour-level-by-sigma 0.01)

;; read the entire dFo struct factor
;; apply suitable sigma cutoff on it
;; and change its colour into cyan-yellow pair
(make-and-draw-map "H309_cycle001/dFc.rc_1600_-400_64.mtz" "dFc" "dPHIc" "" 0 1)
(set-last-map-contour-level-by-sigma 33.00)
(set-last-map-colour 0.0 1.0 1.0)
; (export-map-fragment 3 (rotation-centre-position 0) (rotation-centre-position 1) (rotation-centre-position 2) 20.0 "H309_cycle001/dFc_for_pymol.map")
